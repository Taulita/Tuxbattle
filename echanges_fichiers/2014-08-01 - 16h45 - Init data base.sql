...
--
-- Client: localhost
-- Généré le: Ven 01 Août 2014 à 16:45
...
INSERT INTO `t_joueur` (`id`, `nom`, `email`, `password`, `avatar`, `defaite`, `victoire`, `pv`, `armure`, `strength`, `agility`) VALUES
(1, 'computer', '', '', 0, 0, 0, 1500, 100, 100, 100);
...
(5, 'potion', 'maravak', 0, 0, 100, 0, 0, 0, 0),
